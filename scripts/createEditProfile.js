...
export const createEditProfile = async (login) => {
  ...
  const editAvatarImg = createElement('img', {
  ...
  handleImageFileSelection(editAvatarInput, editAvatarImg, editHiddenInput)
