...
import { deleteWish, getWish, sendDataUser, sendDataWish, updateDataWish } from "./serviceAPI.js";
...
export const createEditWish = async (id) => {
  ...
  const sectionEditWish = createElement('div', {
